...
COMMENT ON COLUMN stock_variants.unit IS NULL;
COMMENT ON COLUMN stock_variants.number_of_units IS NULL;
COMMENT ON COLUMN stock_variants.invoice_id IS NULL;
...
-- Restore NOT NULL constraints on stock_variants (need to set default values first for any nulls)
