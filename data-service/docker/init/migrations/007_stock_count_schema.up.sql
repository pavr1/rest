...
-- Step 4b: Remove deprecated columns from stock_variants (unit and number_of_units now live in stock_count)
...
-- Note: The following columns are deprecated but kept for backward compatibility:
...
-- Step 9: Comment on deprecated columns (only for columns that still exist)
