...
// SQL query constants
const (
	GetSettingsByServiceQuery = "get_settings_by_service"
	GetSettingByKeyQuery      = "get_setting_by_key"
	CreateSettingQuery        = "create_setting"
	UpdateSettingQuery        = "update_setting"
	DeleteSettingQuery        = "delete_setting"
)
