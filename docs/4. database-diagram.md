...
erDiagram
    ...
    Stock_Items }o--|| Invoice_Details : "created_from"

    Stock_Item_Categories ||--o{ Stock_Items : "categorizes"

    Suppliers ||--o{ Invoices_Outcome : "supplies"

    Invoices_Outcome ||--o{ Invoice_Details : "contains"
...
| **inventory-service** | 8090 | Stock_Items, Stock_Item_Categories, Suppliers, Ingredients |
| **invoice-service** | 8092 | Invoices_Outcome, Invoice_Details, Invoices_Income |
...
3. **Inventory System** (inventory-service):
   ...
   - Stock Items track inventory levels and costs directly
   - invoice-service calls API to create/update stock items from purchases

4. **Invoice System** (invoice-service):
   - Invoices: Suppliers → Invoices_Outcome → Invoice_Details
