...
| **invoice-service** (8092) | Purchase Invoices, Invoice Details, Customer Invoices |
...
12. [Invoices (Purchase Invoices)](#12-invoices-purchase-invoices) - Track purchase invoices from suppliers
13. [Invoice Details](#13-invoice-details) - Line items for purchase invoices
...
- **Invoice Details** → **Existences** (one-to-many, cross-service via API)

**Invoice Service Relationships:**
- **Suppliers** → **Purchase Invoices** (one-to-many)
- **Purchase Invoices** → **Invoice Details** (one-to-many)
