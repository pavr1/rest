...
10. [Menu Item Stock Items (Ingredients)](#10-menu-item-stock-items-ingredients) - Link menu items to stock items with quantities
...
### 10. Menu Item Stock Items (Ingredients)
...
| menu_item_id | UUID | FOREIGN KEY → menu_items.id, NOT NULL, ON DELETE CASCADE | Menu item reference |
...
- **Customers** → **Orders** (one-to-many, optional)
- **Orders** → **Order Items** (one-to-many)
- **Order Items** → **Menu Items** (many-to-one)
- **Menu Categories** → **Sub Menus** (one-to-many)
- **Sub Menus** → **Menu Items** (one-to-many)
- **Menu Items** → **Menu Item Stock Items (Ingredients)** (one-to-many)
- **Stock Items** → **Menu Item Stock Items (Ingredients)** (one-to-many)
- **Stock Items** → **Stock Item Categories** (many-to-one)
- **Stock Items** → **Existences** (one-to-many)
- **Suppliers** → **Invoices** (one-to-many)
- **Invoices** → **Invoice Details** (one-to-many)
- **Invoice Details** → **Existences** (one-to-many)
- **Customers** → **Customer Favorites** (one-to-many)
- **Menu Items** → **Customer Favorites** (one-to-many)
- **Orders** → **Promotions** (many-to-one, optional)
- **Orders** → **Payments** (one-to-many)
- **Orders** → **Invoices** (one-to-one) - Note: This is for customer invoices (receipts), not purchase invoices
- **Payments** → **Invoices** (one-to-one, optional) - Note: Customer invoices/receipts
- **Promotions** → **Orders** (one-to-many) - Promotions can be applied to multiple orders
- **Customers** → **Loyalty Points Transactions** (one-to-many)
- **Orders** → **Loyalty Points Transactions** (one-to-many) - Orders can generate multiple point transactions (earned/spent)
- **Tables** → **Request Notifications** (one-to-many)
- **Tables** → **Karaoke Song Requests** (one-to-many)
