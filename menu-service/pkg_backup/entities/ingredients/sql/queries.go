...
// SQL query constants
const (
	ListIngredientsQuery        = "list_ingredients"
	GetIngredientQuery          = "get_ingredient"
	CreateIngredientQuery       = "create_ingredient"
	UpdateIngredientQuery       = "update_ingredient"
	DeleteIngredientQuery       = "delete_ingredient"
	CalculateMenuItemCostQuery  = "calculate_menu_item_cost"
)
